...
public struct Point2 : IEquatable<Point2>
{
	...
	public Point2 Clamp(in Point2 min, in Point2 max) =>
		new Point2(IntExt.Clamp(X, min.X, max.X), IntExt.Clamp(Y, min.Y, max.Y));
...
*/
	...
	public static Point2 Min(Point2 a, Point2 b, Point2 c) => new(GameMath.Min(a.X, b.X, c.X), GameMath.Min(a.Y, b.Y, c.Y));
	public static Point2 Min(Point2 a, Point2 b, Point2 c, Point2 d) => new(GameMath.Min(a.X, b.X, c.X, d.X), GameMath.Min(a.Y, b.Y, c.Y, d.Y));

	public static Point2 Max(Point2 a, Point2 b) => new(Math.Max(a.X, b.X), Math.Max(a.Y, b.Y));
	public static Point2 Max(Point2 a, Point2 b, Point2 c) => new(GameMath.Max(a.X, b.X, c.X), GameMath.Max(a.Y, b.Y, c.Y));
	public static Point2 Max(Point2 a, Point2 b, Point2 c, Point2 d) => new(GameMath.Max(a.X, b.X, c.X, d.X), GameMath.Max(a.Y, b.Y, c.Y, d.Y));
	...
	public static Rectangle operator +(Point2 a, Rectangle b) => new(a.X + b.X, a.Y + b.Y, b.Width, b.Height);
	public static Rectangle operator +(Rectangle a, Point2 b) => new(b.X + a.X, b.Y + a.Y, a.Width, a.Height);

	public static Rectangle operator -(Rectangle a, Point2 b) => new(a.X - b.X, a.Y - b.Y, a.Width, a.Height);

	//public static RectaInt operator +(Point2 a, RectInt b) => new(a.X + b.X, a.Y + b.Y, b.Width, b.Height);
